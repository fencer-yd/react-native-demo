...
var _jsxFileName = '/Users/yangdeng/myProject/reactApp/demoApp/node_modules/rn-viewpager/viewpager/indicator/PagerTitleIndicator.js';
        ...
        value: function render() {
            ...
            var titleViews = titles.map(function (title, index) {
                ...
                var titleView = _this2.props.renderTitle ? _this2.props.renderTitle(index, title, isSelected) : _react2.default.createElement(
                    _reactNative.Text,
                    { style: isSelected ? [styles.titleTextSelected, selectedItemTextStyle] : [styles.titleText, itemTextStyle], __source: {
                ...
                return _react2.default.createElement(
                    ...
                    titleView,
                    isSelected ? _react2.default.createElement(_reactNative.View, { style: [styles.selectedBorder, selectedBorderStyle], __source: {
                            fileName: _jsxFileName,
                            lineNumber: 65
                        }
                    }) : null
            ...
            return _react2.default.createElement(
                _reactNative.View,
                { style: [styles.indicatorContainer, this.props.style], __source: {
                        fileName: _jsxFileName,
                        lineNumber: 70
                    }
                },
...
PagerTitleIndicator.propTypes = babelHelpers.extends({}, _reactNative.View.propTypes, {
    ...
    renderTitle: _react2.default.PropTypes.func
});
