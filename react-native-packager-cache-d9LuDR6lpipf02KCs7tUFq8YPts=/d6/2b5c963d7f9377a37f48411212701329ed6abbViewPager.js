...
var _jsxFileName = '/Users/yangdeng/myProject/reactApp/demoApp/node_modules/rn-viewpager/viewpager/ViewPager.js';
...
var ViewPager = function (_Component) {
    ...
    babelHelpers.createClass(ViewPager, [{
        ...
        value: function render() {
            return _reactNative.Platform.OS === 'ios' ? this._renderOnIOS() : _react2.default.createElement(_reactNative.ViewPagerAndroid, babelHelpers.extends({}, this.props, {
                ref: VIEWPAGER_REF,
        ...
        value: function setPageWithoutAnimation(selectedPage) {
            if (_reactNative.Platform.OS === 'ios') this.refs[SCROLLVIEW_REF].scrollTo({ x: this.state.width * selectedPage, animated: false });else {
        ...
        value: function setPage(selectedPage) {
            if (_reactNative.Platform.OS === 'ios') this.refs[SCROLLVIEW_REF].scrollTo({ x: this.state.width * selectedPage });else {
